...
1.  **External Standards Body Documentation** (W3C Process Document / Respec, IETF RFC 7991 / RFC 7322, ISO Directives Part 2, IEEE SA Standards Style Manual) — Benchmarking Authority
