...
* **Program governance context (internal)**:
  ...
  * `prompt/artifacts/tasks/P/workspace/plan/plan_P-PH000-ST004.md`
  * `prompt/artifacts/tasks/P/workspace/plan/PH000/ST001/plan_P-PH000-ST001-AC003.md`
...
* **Brief Version**: `prompt/artifacts/tasks/P/research/brief/brief_P-RES-001_status-standard-research.md` (v1.0.0, 2026-02-24)
* **Code Commit/Tag**: —
