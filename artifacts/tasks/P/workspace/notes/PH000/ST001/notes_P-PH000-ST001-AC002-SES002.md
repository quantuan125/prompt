...
raw_transcript_reference: 'prompt/artifacts/tasks/P/workspace/raw/PH000/ST001/raw_P-PH000-ST001_AC002_SES002.txt'
---
...
**TK002 deliverable direction**: Client directed that TK002's deliverable be a standalone proposal file under `prompt/artifacts/tasks/P/workspace/proposal/`, not embedded in the plan. The proposal file serves as the gated input to TK003 and may embed the gap analysis for traceability.
...
| `P-PH000-ST001-AC002-SES002-DEC004` | TK002 deliverable is a proposal file at `prompt/artifacts/tasks/P/workspace/proposal/`; file must pass GATE-001 before TK003 | PLANNING | Confirmed | Client | 2026-02-20 | Keeps promotion contract as reviewable standalone artifact; follows proposal pattern | Client direction | — |
...
- **Proposal file**: `prompt/artifacts/tasks/P/workspace/proposal/proposal_P-PH000-ST001-AC002_promotion-contract-t102-std-004-to-p-std-001.md` — completed, decision-ready for GATE-001.
- **Raw transcript**: `prompt/artifacts/tasks/P/workspace/raw/PH000/ST001/raw_P-PH000-ST001_AC002_SES002.txt` — migrated from workspace root.
