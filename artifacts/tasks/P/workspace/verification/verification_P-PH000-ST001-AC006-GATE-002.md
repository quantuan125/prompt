...
- `prompt/artifacts/tasks/P/workspace/proposal/proposal_P-PH000-ST001-AC006_promotion-contract-t102-std-005-to-p-std-005.md` (TK004 deliverable)

**Plan & governance references**
- `prompt/artifacts/tasks/P/workspace/plan/PH000/ST001/plan_P-PH000-ST001-AC006.md` (v1.1.0)
...
- `prompt/artifacts/tasks/P/workspace/proposal/proposal_P-PH000-ST001-AC002_promotion-contract-t102-std-004-to-p-std-001.md` (structural precedent)

**TK003 audit reference**
- `prompt/artifacts/tasks/P/workspace/analysis/analysis_P-PH000-ST001-AC006_pre-promotion-audit.md`
...
| TK004 Proposal (v1.0.0) | `prompt/artifacts/tasks/P/workspace/proposal/proposal_P-PH000-ST001-AC006_promotion-contract-t102-std-005-to-p-std-005.md` |
...
| P-STD-001 promotion contract (precedent) | `prompt/artifacts/tasks/P/workspace/proposal/proposal_P-PH000-ST001-AC002_promotion-contract-t102-std-004-to-p-std-001.md` |
| TK003 audit | `prompt/artifacts/tasks/P/workspace/analysis/analysis_P-PH000-ST001-AC006_pre-promotion-audit.md` |
...
| GATE-001 verification | `prompt/artifacts/tasks/P/workspace/verification/verification_P-PH000-ST001-AC006_gate-001.md` |
| This verification | `prompt/artifacts/tasks/P/workspace/verification/verification_P-PH000-ST001-AC006-GATE-002.md` |
