...
2. Find the `P-STD-001` row and update the following columns:
   ...
   - `Reference`: `prompt/artifacts/tasks/P/workspace/PH000/ST001/AC002/plan_P-PH000-ST001-AC002.md` → add the canonical path: `prompt/artifacts/tasks/P/standard/standard_P-STD-001_program-governance-standard.md`
...
**Deliverable**:
- Verification artifact at `prompt/artifacts/tasks/P/workspace/PH000/ST001/AC002/verification/`.
...
6. Confirm raw transcript existence: `prompt/artifacts/tasks/P/workspace/PH000/ST001/AC002/raw/raw_P-PH000-ST001-AC002-SES002.txt` (or note as pending).
...
- Independent GATE-002 verification artifact exists at `prompt/artifacts/tasks/P/workspace/PH000/ST001/AC002/verification/verification_P-PH000-ST001-AC002_gate-002.md`.
...
|:--|:--|:--|
| Plan (this file) | AC002 Activity Plan | `prompt/artifacts/tasks/P/workspace/PH000/ST001/AC002/plan_P-PH000-ST001-AC002.md` |
