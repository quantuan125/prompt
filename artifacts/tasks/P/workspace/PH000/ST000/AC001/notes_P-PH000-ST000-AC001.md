...
plan_reference: 'prompt/artifacts/tasks/P/workspace/PH000/ST000/plan_P-PH000-ST000.md'
notes_register_reference: 'prompt/artifacts/tasks/P/workspace/PH000/ST000/notes_P-PH000-ST000.md'
raw_source:
  - 'prompt/artifacts/tasks/P/workspace/PH000/ST000/AC001/raw/raw_P-PH000-ST000-AC001-SES001.txt'
---
...
The consultation confirmed that program-level governance requires a deterministic physical home independent of any single initiative. The canonical program root was selected as `prompt/artifacts/tasks/P/**`, and the authority boundary for the first program standards was constrained to `prompt/artifacts/tasks/**` (including raw, SSOT, workspace, and planning artifacts) rather than all of `prompt/**`.
...
|:---|:------|:--------|:----------|:---------|
| `P-PH000-ST000-AC001-DP001` | Program SSOT Location | Use `prompt/artifacts/tasks/P/**` as canonical program root | Keeps program governance decoupled from any single initiative | Raw transcript |
...
|:---|:---------|:-----|:-------|:------|:-----|:----------|:------------------|:---------|
| `P-PH000-ST000-AC001-DEC001` | Canonical program governance root is `prompt/artifacts/tasks/P/**` | Governance | Confirmed | Client | 2026-02-05 | Deterministic SSOT location required for program standards | Plan artifacts created under this root | Raw transcript |
...
- Program phase plan: `prompt/artifacts/tasks/P/workspace/PH000/plan_P-PH000.md`
- Program stream plans: `prompt/artifacts/tasks/P/workspace/PH000/ST000/plan_P-PH000-ST000.md`, `plan_P-PH000-ST001.md`, `plan_P-PH000-ST002.md`
- Program notes registers: `prompt/artifacts/tasks/P/workspace/PH000/notes_P-PH000.md`, `notes_P-PH000-ST000.md`
- Activity notes (this file): `prompt/artifacts/tasks/P/workspace/PH000/ST000/AC001/notes_P-PH000-ST000-AC001.md`
- Program SPS shell: `prompt/artifacts/tasks/P/ssot/sps_P-PROGRAM.md`
- Canonical raw transcript: `prompt/artifacts/tasks/P/workspace/PH000/ST000/AC001/raw/raw_P-PH000-ST000-AC001-SES001.txt`

**Deferred / planned**:
- Program status system artifact: `prompt/artifacts/tasks/P/status/status_program.md` (planned as `P-PH000-ST002-AC002`)
