...
**Deliverables**:
- `prompt/artifacts/tasks/P/workspace/PH000/notes_P-PH000.md`
- `prompt/artifacts/tasks/P/workspace/PH000/ST000/notes_P-PH000-ST000.md`
- `prompt/artifacts/tasks/P/workspace/PH000/ST000/AC001/notes_P-PH000-ST000-AC001.md`
...
| `P-PH000-ST000-AC001-TK003` | Relocate raw transcript to program raw directory and reference it canonically | `completed` | Raw moved to `prompt/artifacts/tasks/P/workspace/PH000/ST000/AC001/raw/` and referenced by Notes/Plans |
...
|:--|:--|:--|
| Plan (this file) | Stream 0 Plan | `prompt/artifacts/tasks/P/workspace/PH000/ST000/plan_P-PH000-ST000.md` |
| Parent Plan | Program Phase Plan | `prompt/artifacts/tasks/P/workspace/PH000/plan_P-PH000.md` |
