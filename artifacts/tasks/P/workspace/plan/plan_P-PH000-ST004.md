...
- `prompt/artifacts/tasks/P/research/brief/brief_P-RES-001_status-standard-research.md`
...
- `prompt/artifacts/tasks/P/workspace/plan/plan_P-PH000-ST002.md` — ST002-AC001 schema (informative seed)
...
|:--|:--|:--|
| Plan (this file) | Stream ST004 Plan | `prompt/artifacts/tasks/P/workspace/plan/plan_P-PH000-ST004.md` |
| Plan | Phase Plan | `prompt/artifacts/tasks/P/workspace/plan/plan_P-PH000.md` |
