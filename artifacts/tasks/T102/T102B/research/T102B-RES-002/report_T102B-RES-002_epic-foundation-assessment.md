...
*   **SSOT / Governance**:
    *   `prompt/artifacts/tasks/T102/ssot/sps_T102-CONSULTANT.md` (T102A exemplar + T102B current dossier)
    *   `prompt/artifacts/tasks/T102/ssot/concept_T102-CONSULTANT.md` (T102-STD-003/004/005/006/007 standards)
*   **Research Inputs**:
    *   `prompt/artifacts/tasks/T102/T102B/research/T102B-RES-001/report_T102B-RES-001_request-artifact-analysis.md` (W1–W7, P1–P8, S1–S8, and issue/risk candidates)
*   **Exemplars**:
...
*   **Source**: `prompt/artifacts/tasks/T102/ssot/sps_T102-CONSULTANT.md` (T102A epic requirements and T102B epic block).
*   **Observation**:
...
#### A. Evidence & Forensics
*   **Source**: `prompt/artifacts/tasks/T102/ssot/sps_T102-CONSULTANT.md` (T102B “Epic Governance Decisions” is empty).
*   **Source**: `prompt/artifacts/tasks/T102/T102B/research/T102B-RES-001/report_T102B-RES-001_request-artifact-analysis.md` (recommends 4 epic ADR candidates: ADR-001..004).
*   **Standard**: `prompt/artifacts/tasks/T102/ssot/concept_T102-CONSULTANT.md` (`T102-STD-004` pairing and precedence; `T102-STD-005` ID rules).
...
#### A. Evidence & Forensics
*   **Source**: `prompt/artifacts/tasks/T102/ssot/sps_T102-CONSULTANT.md`:
...
*   **Source**: `prompt/artifacts/tasks/T102/ssot/concept_T102-CONSULTANT.md`:
...
#### A. Evidence & Forensics
*   **Source**: `prompt/artifacts/tasks/T102/T102B/research/T102B-RES-001/report_T102B-RES-001_request-artifact-analysis.md`
...
*   **Source**: `prompt/artifacts/tasks/T102/ssot/sps_T102-CONSULTANT.md` (T102B Notes and current Issues/Risks).
...
#### A. Evidence & Forensics
*   **Source**: `prompt/artifacts/tasks/T102/T102B/research/T102B-RES-001/report_T102B-RES-001_request-artifact-analysis.md` Topic 9 (workflow typology) and proposals P1/P2.
...
#### A. Evidence & Forensics
*   **Source**: `prompt/artifacts/tasks/T102/ssot/sps_T102-CONSULTANT.md` (T102A IG-001..006 patterns).
