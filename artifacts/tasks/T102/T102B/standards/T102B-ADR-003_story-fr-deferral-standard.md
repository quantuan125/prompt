# T102B-ADR-003 — Story FR Deferral Standard
...
1) **T102B-ADR-003-CLAUSE-001 (Story Index Structure)**
...
2) **T102B-ADR-003-CLAUSE-002 (Deferral Boundary)**
...
3) **T102B-ADR-003-CLAUSE-003 (Exceptions)**
