...
3. Promote standards into `T102` governance:
   - Update `prompt/artifacts/tasks/T102/ssot/concept_T102-CONSULTANT.md` to include `T102A-STD-001` updates, add `T102A-STD-002`, add `T102-GDR-008`, and update `T102-STD-008`, ensuring DR index schemas conform to `T102-STD-004`.
   - Implement `T102-GDR-008` under `III.B.9` in `prompt/artifacts/tasks/T102/archive/versioned/ssot/sps_T102-CONSULTANT_v1.1.0.md` (and update any downstream ADR contexts if the governing GDR changes status/supersedes per `T102-STD-004-FR-007`).
