...
- `prompt/artifacts/tasks/T102/workspace/PH000/analysis/analysis_T102-RES-005_cross-scope-coordination-architecture.md` (STD-003 schema enforcement deltas; coordination architecture boundary)
...
|:--|:--|:--|
| Plan (this file) | ST002 Plan | `prompt/artifacts/tasks/T102/T102A/workspace/PH001/ST002/plan_T102A-PH001-ST002.md` |
...
| Standard | Decision Records Standard exemplar | `prompt/artifacts/tasks/T102/standard/standard_T102-STD-004_specification-standard-and-guideline.md` |
