...
- `prompt/artifacts/tasks/T102/research/T102-RES-001/report_T102-RES-001_research-integration-workflow.md`
...
**Inputs Required**:
- `prompt/artifacts/tasks/T102/workspace/PH000/analysis/analysis_T102-RES-004_issues-risks-architecture.md` (staleness data §II Finding 1; content filtering tree §II Finding 6; promotion rules §II Finding 5)
...
|:--|:--|:--|
| Plan (this file) | ST001 Plan | `prompt/artifacts/tasks/T102/T102A/workspace/PH001/ST001/plan_T102A-PH001-ST001.md` |
...
| Research Program | T102 PH001 ST004 | `prompt/artifacts/tasks/T102/workspace/PH001/ST004/plan_T102-PH001-ST004.md` |
