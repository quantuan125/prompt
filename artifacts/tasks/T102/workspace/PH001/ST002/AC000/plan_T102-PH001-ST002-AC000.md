...
| GATE-001 | `T102-PH001-ST002-AC000-GATE-001` | Gate: Client approval of AC000 diagnostic deliverables | `in_progress` | Client | TK010.5 | Pass/fail | `guideline_workspace_plan.md` §VI.K | Same-gate recycle loop is complete and the refreshed client re-presentation package is ready for decision. |
...
| TK011 | `T102-PH001-ST002-AC000-TK011` | Execute implementation per TK010 downstream execution contract | `blocked` | LLM_Developer | GATE-001 | Target STD files and AC000 implementation surfaces named in TK010 | `implementation/implementation_T102-PH001-ST002-AC000_tk010_gate-001-downstream-seed-task-specification.md` | Blocked pending client approval at the same gate, which activates TK010 as the bounded downstream execution contract. |
