...
- `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-006_research-artifacts-index.md` (register architecture precedent)
...
- Feature Request exemplar (contains feature-level I&R): `prompt/artifacts/tasks/T102/T102B/request/request_T102B1-RST.md`
