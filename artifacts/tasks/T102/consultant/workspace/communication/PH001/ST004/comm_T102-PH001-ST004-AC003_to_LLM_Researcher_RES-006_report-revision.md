...
- RES-004 directives are specified in `prompt/artifacts/tasks/T102/consultant/workspace/analysis/analysis_T102-RES-004_issues-risks-architecture.md:281`
- RES-005 directives are specified in `prompt/artifacts/tasks/T102/consultant/workspace/analysis/analysis_T102-RES-005_cross-scope-coordination-architecture.md:274`
...
- `prompt/artifacts/tasks/T102/consultant/concept/concept_T102-CONSULTANT.md` (Section `E.3 Research Artifacts Register`)
