...
| `T102-GDR-008` | `T102-STD-008` | `T102-ADR-008 (Organisation Baseline Standard)` | — |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `T102-ADR-009` | **Governance Standards Specification** | `T102-STD-009 (Governance Standards Model)` | `Proposed` | Client | — | #t102-adr-009-governance-standards-spec |
  ...
  * **Specification**
    ...
    * **T102-ADR-009-CLAUSE-004 (STD Authoring Requirements)**
      ...
      * **T102-ADR-009-CLAUSE-004B (STD Index Column Guidelines)**
        ...
        - `Reference`: MUST list governing IDs such as `T102-ADR-005` and initiative-wide constraints (e.g., `T102-CON-009`).
