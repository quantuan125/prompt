...
- **SSOT Artifacts**:
  ...
  - `prompt/artifacts/tasks/T102/T102B/request/request_T102B1-RST.md`
...
- **Standards**:
  ...
  - `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-006_research-artifacts-index.md` (for register-architecture analogy)
- **Consultation Notes**:
  - `prompt/artifacts/tasks/T102/T102B/workspace/notes/PH001/ST001/notes_T102B-PH001-ST001-AC002.md` (D2/D6)
...
- **Initiative I&R** exists in SPS Section III.B.10:
  - Source: `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (Section “10. Issues & Risks”).
...
- **Feature I&R** exists in only one Feature-level Request:
  - Source: `prompt/artifacts/tasks/T102/T102B/request/request_T102B1-RST.md` (Section “H. Issues & Risks”).
- **Concept artifact** does not currently host an I&R register/table:
  - Source: `prompt/artifacts/tasks/T102/consultant/concept/concept_T102-CONSULTANT.md` (no “Issues & Risks” section/tables present).
...
#### A. Evidence & Forensics
- Source: `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-007_issues-risks-index.md`
- Related constraints:
  - `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-003_explicit-inheritance-model.md`
  - `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-005_id-specification-rules.md` (notably: Issues/Risks are OIDs; normative bodies must not reference ISSUE/RISK inline).
...
#### A. Evidence & Forensics
- Feature-level I&R exists in `prompt/artifacts/tasks/T102/T102B/request/request_T102B1-RST.md` Section H with 2 Issues and 1 Risk.
...
- AC002 re-review decisions:
  ...
  - Source: `prompt/artifacts/tasks/T102/T102B/workspace/notes/PH001/ST001/notes_T102B-PH001-ST001-AC002.md`.
...
#### A. Evidence & Forensics
- Current promotion guidance exists only as Epic→Initiative SHOULD guidance: `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-007_issues-risks-index.md` (CLAUSE-009).
- Directionality constraint: upstream scopes must not reference downstream rules: `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-003_explicit-inheritance-model.md`.
...
**Brief Version**: `prompt/artifacts/tasks/T102/consultant/research/brief/brief_T102-RES-004_issues-risks-architecture.md` (v1.0.0, 2026-02-09)
...
- `prompt/artifacts/tasks/T102/T102B/workspace/notes/PH001/ST001/notes_T102B-PH001-ST001-AC002.md`
