...
- **SSOT Artifacts (primary evidence)**:
  ...
  - Example Request (explicitly treated as *draft / in-development exemplar*): `prompt/artifacts/tasks/T102/T102B/request/request_T102B1-RST.md`
- **Standards (authoritative inputs)**:
  ...
  - `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-007_issues-risks-index.md` (report-section compliance only)
- **Governance / context**:
  - `prompt/artifacts/tasks/T102/consultant/workspace/plan/plan_T102-PH001-ST004.md`
  - `prompt/artifacts/tasks/T102/consultant/workspace/notes/PH001/ST004/notes_T102-PH001-ST004-AC002.md`
  - `prompt/artifacts/tasks/T102/consultant/raw/PH001/ST004/raw_T102-PH001-ST004_AC000_2026-02-09_p1.txt`
  - `prompt/artifacts/tasks/T102/consultant/workspace/analysis/analysis_T102-RES-004_issues-risks-architecture.md` (cross-topic integration context)
...
- Inherited Considerations tables appear as repeated "coordination snapshots" in SPS epic dossiers and in feature Requests:
  - SPS epic dossier example: `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (Epic sections include "Inherited Considerations" tables).
  - Feature Request exemplar includes a 13-row Inherited Considerations table with 39 back-ticked inherited ID tokens: `prompt/artifacts/tasks/T102/T102B/request/request_T102B1-RST.md` (Section "E. Inherited Considerations").
- Research indexing is dual-surface by design:
  - SPS initiative Research table: `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (Section "9. Research").
  - Concept master Research Artifacts Register: `prompt/artifacts/tasks/T102/consultant/concept/concept_T102-CONSULTANT.md` (Section "E.3. Research Artifacts Register").
- Token-based integration coordination exists via `INT` items:
  - Example: `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (T102B "Integration Guidance", includes `T102B-INT-001` .. `T102B-INT-006`).
- Directionality safety is governed by `T102-STD-005-CLAUSE-003` and `T102-STD-005-CLAUSE-005C` (INT scoped peer-reference exception at Feature/Story scope):
  - `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-005_id-specification-rules.md` (CLAUSE-003, CLAUSE-005C).
...
- `T102-STD-003` specifies a strict table schema and small per-row inherited ID lists (<=5 items) and delta-only authoring:
  - `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-003_explicit-inheritance-model.md` (CLAUSE-001..003).
- Observed schema drift exists in SSOT artifacts:
  - SPS epic table columns use `Source ID` not `Scope ID`, and categories include `Governance` (singular), while STD-003 enumerates `Governances`:
    - `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (epic "Inherited Considerations" tables).
  - SPS T102C epic dossier uses `Inherited Rule IDs (with hints)` column name:
    - `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (T102C epic dossier inherited considerations).
- Feature Request exemplar shows "bloat pressure" at Feature scope:
  - `prompt/artifacts/tasks/T102/T102B/request/request_T102B1-RST.md` includes 13 rows in the table and 39 back-ticked inherited ID tokens.
...
- `INT` is defined as non-normative integration guidance with constraints and a promotion loop:
  - `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-005_id-specification-rules.md` (`T102-STD-005-CLAUSE-005C`).
- `INT` is actively used in SPS T102B Integration Guidance to coordinate handoffs and define compatibility expectations:
  - `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (T102B Integration Guidance, e.g., `T102B-INT-001`, `T102B-INT-006`).
...
- `T102-STD-006` mandates dual indexing: local SPS tables and Concept master register:
  - `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-006_research-artifacts-index.md` (CLAUSE-002..004).
- SPS initiative Research table exists and includes `T102-RES-001..004`:
  - `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (Section "9. Research").
- Concept master Research Artifacts Register exists, but entries reference missing versioned filenames and a missing versioned SPS source file:
  - `prompt/artifacts/tasks/T102/consultant/concept/concept_T102-CONSULTANT.md` (E.3 table includes links to `*_v1.0.0.md` and sources like `sps_T102-CONSULTANT_v1.1.0.md` which do not exist in repo).
...
#### A. Evidence & Forensics
- The operating model defines the role boundaries for SPS/Request/Concept: `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-001_consultancy-operating-model.md`.
...
**Brief Version**: `prompt/artifacts/tasks/T102/consultant/research/brief/brief_T102-RES-005_cross-scope-coordination-architecture.md` (v1.0.0, 2026-02-09)
...
- `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md`
- `prompt/artifacts/tasks/T102/consultant/concept/concept_T102-CONSULTANT.md`
- `prompt/artifacts/tasks/T102/T102B/request/request_T102B1-RST.md` (draft exemplar)
