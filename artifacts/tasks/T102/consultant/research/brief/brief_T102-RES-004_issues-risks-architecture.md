...
* `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-007_issues-risks-index.md` — Primary standard under evaluation
* `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-003_explicit-inheritance-model.md` — Cross-scope referencing model
* `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-006_research-artifacts-index.md` — Research governance
* `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-001_consultancy-operating-model.md` — Operating model (reference baseline; `Proposed` status)
* `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-005_id-specification-rules.md` — ID construction rules

### C. Decision Evidence & Exemplars

* AC002 re-review notes (D2/D6/D7): `prompt/artifacts/tasks/T102/T102B/workspace/notes/PH001/ST001/notes_T102B-PH001-ST001-AC002.md`
* Initiative-level I&R exemplar: `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (Section III.B.10)
* Epic-level I&R exemplars:
  - T102A: `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (Section III.C.1.ix)
  - T102B: `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (Section III.C.2.x)
  - T102C: `prompt/artifacts/tasks/T102/consultant/sps/sps_T102-CONSULTANT.md` (Section III.C.3.ix)
* Feature-level I&R exemplar: `prompt/artifacts/tasks/T102/T102B/request/request_T102B1-RST.md` (Section H)
