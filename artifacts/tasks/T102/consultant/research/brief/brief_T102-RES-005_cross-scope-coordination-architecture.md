...
* Activity Notes (scope/amendment evidence): `prompt/artifacts/tasks/T102/consultant/workspace/notes/PH001/ST004/notes_T102-PH001-ST004-AC002.md`
* Raw transcript (evidence): `prompt/artifacts/tasks/T102/consultant/raw/PH001/ST004/raw_T102-PH001-ST004_AC000_2026-02-09_p1.txt`
* T102-RES-004 analysis and synthesis: `prompt/artifacts/tasks/T102/consultant/workspace/analysis/analysis_T102-RES-004_issues-risks-architecture.md`
...
* `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-005_id-specification-rules.md` (including `INT` semantics)
* `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-006_research-artifacts-index.md` (subtopic)
* `prompt/artifacts/tasks/T102/consultant/standards/T102-STD-007_issues-risks-index.md` (report Issues & Risks section schema)
...
* RES-004 brief (style baseline): `prompt/artifacts/tasks/T102/consultant/research/brief/brief_T102-RES-004_issues-risks-architecture.md`
