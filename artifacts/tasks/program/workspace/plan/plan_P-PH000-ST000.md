...
**Context**:
- Raw transcript: `prompt/artifacts/tasks/program/raw/PH000/ST000/raw_P-PH000-ST000-AC001-2026-02-05.txt`
...
| AC002 | `P-PH000-ST000-AC002` | Create Program SPS shell (`sps_P-PROGRAM.md`) | `completed` | LLM_Consultant | AC001 | `prompt/artifacts/tasks/program/ssot/sps_P-PROGRAM.md` | SPS template |
...
**Deliverables**:
- `prompt/artifacts/tasks/program/workspace/notes/notes_P-PH000.md`
- `prompt/artifacts/tasks/program/workspace/notes/notes_P-PH000-ST000.md`
- `prompt/artifacts/tasks/program/workspace/notes/PH000/ST000/notes_P-PH000-ST000-AC001.md`
...
| `P-PH000-ST000-AC001-TK003` | Relocate raw transcript to program raw directory and reference it canonically | `completed` | Raw moved to `prompt/artifacts/tasks/program/raw/PH000/ST000/` and referenced by Notes/Plans |
...
**Deliverable**:
- `prompt/artifacts/tasks/program/ssot/sps_P-PROGRAM.md`
...
- `prompt/artifacts/tasks/program/research/report/report_P-RES-001_pm-tooling-status-orchestration.md`
...
|:--|:--|:--|
| Plan (this file) | Stream 0 Plan | `prompt/artifacts/tasks/program/workspace/plan/plan_P-PH000-ST000.md` |
| Parent Plan | Program Phase Plan | `prompt/artifacts/tasks/program/workspace/plan/plan_P-PH000.md` |
