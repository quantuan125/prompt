...
**Important constraint**: `prompt/artifacts/tasks/program/status/status_program.md` MUST NOT be created until `P-PH000-ST001-AC003` (Program Status Standard) is authored and accepted.
...
| AC002 | `P-PH000-ST002-AC002` | Author `status_program.md` (deferred implementation activity) | `planned` | LLM_Consultant | ST001-AC003, AC001 | `prompt/artifacts/tasks/program/status/status_program.md` | `P-STD-002` |
...
- `prompt/artifacts/tasks/program/status/status_program.md`
