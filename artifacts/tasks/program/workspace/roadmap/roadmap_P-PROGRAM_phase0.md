...
- Program governance root is `prompt/artifacts/tasks/program/**` (see program SPS).
...
- `prompt/artifacts/tasks/program/ssot/sps_P-PROGRAM.md` — program governance shell and standards placeholders.
...
- `prompt/artifacts/tasks/T102/consultant/concept/concept_T102-CONSULTANT.md#t102-adr-009-governance-standards-spec` — governance standards specification clauses.
...
| 2 | 2.1 | **Draft P-STD-003 (Combined Governance Model)** | Planned | LLM_Consultant | SEQUENTIAL | 1.1 | — | — | — | `prompt/artifacts/tasks/program/standard/P-STD-003_governance-standards-and-dr-index.md` |
...
**Status**: Planned
**Deliverable**: `prompt/artifacts/tasks/program/standard/P-STD-003_governance-standards-and-dr-index.md`
...
|:----------|:-------|:-----|
| Roadmap (this file) | Program Phase 0 Roadmap | `prompt/artifacts/tasks/program/workspace/roadmap/roadmap_P-PROGRAM_phase0.md` |
| Changelog | Roadmap Changelog | `prompt/artifacts/tasks/program/workspace/roadmap/changelog_roadmap_P-PROGRAM_phase0.md` |
| SSOT | Program SPS | `prompt/artifacts/tasks/program/ssot/sps_P-PROGRAM.md` |
| Standard | P-STD-003 Draft | `prompt/artifacts/tasks/program/standard/P-STD-003_governance-standards-and-dr-index.md` |
| Reference | T102 ADR-004 Standard | `prompt/artifacts/tasks/T102/consultant/standards/T102-ADR-004_decision-records-index.md` |
| Reference | T102 ADR-009 Spec (Concept) | `prompt/artifacts/tasks/T102/consultant/concept/concept_T102-CONSULTANT.md#t102-adr-009-governance-standards-spec` |
...
`prompt/artifacts/tasks/program/workspace/roadmap/changelog_roadmap_P-PROGRAM_phase0.md`
