...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dest-dir",
        default=".codex/skills/t102-adr-004-drs-index",
        help="Destination mirror directory (default: .codex/skills/t102-adr-004-drs-index)",
    )
    parser.add_argument(
        "--check",
        action="store_true",
...
def main() -> int:
    ...
    print_script = ssot_dir / "scripts/print_t102_adr_004.py"
