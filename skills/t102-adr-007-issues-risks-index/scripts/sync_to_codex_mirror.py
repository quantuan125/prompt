...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dest-dir",
        default=".codex/skills/t102-adr-007-issues-risks-index",
        help="Destination mirror directory (default: .codex/skills/t102-adr-007-issues-risks-index)",
    )
    parser.add_argument(
        "--check",
        action="store_true",
...
def main() -> int:
    ...
    print_script = ssot_dir / "scripts/print_t102_adr_007.py"
